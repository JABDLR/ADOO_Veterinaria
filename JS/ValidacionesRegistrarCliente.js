...
function desplegarInfo(){
    ...
    var texto = " Hola "+nombre+ " "+apellidoP+" "+apellidoM+",verifica que los datos que ingresaste sean correctos:<br><br><strong>Fecha de nacimiento: </strong>"+Fnacimiento+"<br><strong>Genero: </strong>"+genero+"<br><strong>CURP: </strong>"+curp+"<br><strong>Calle y número: </strong>"+calleN+"<br><strong>Colonia: </strong>"+colonia+"<br><strong>Alcaldia: </strong>"+alcaldia+"<br><strong>Codigo postal: </strong>"+CP+"<br><strong>Teléfono o celular: </strong>"+telefono+"<br><strong>Correo electrónico: </strong>"+correo+"<br>";
...
function aceptarCambios(){
    ...
    window.location.href = "php/guardarDatos.php?nombre="+nombre+"&apeP="+apellidoP+"&apeM="+apellidoM+"&fecha="+Fnacimiento+"&genero="+genero+"&curp="+curp+"&calleN="+calleN+"&col="+colonia+"&alcaldia="+alcaldia+"&cp="+CP+"&tel="+telefono+"&correo="+correo+"&user="+usuario;  
